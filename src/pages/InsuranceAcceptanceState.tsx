    ...
    <div className="bg-[#FCFAF7] selection:bg-brand-teal/20 text-[#1F2937] pt-32 lg:pt-44 font-sans min-h-screen">
      ...
      <section className="px-6 lg:px-12 max-w-7xl mx-auto mb-16">
        <div className="flex flex-col lg:flex-row justify-between gap-12 items-start">
          ...
          <div className="flex-1 space-y-8">
            <div>
              <h1 className="text-h1 font-kids font-bold text-[#1F2937] mb-4">
                Insurance accepted <br />
                <span className="text-brand-teal italic">by state.</span>
              </h1>
              <p className="text-body-lg text-brand-sage font-medium max-w-xl">
            ...
            <div className="relative max-w-2xl group">
              ...
              <input 
                ...
                className="w-full pl-16 pr-8 py-6 bg-white border border-gray-100 rounded-[32px] shadow-sm focus:shadow-md focus:border-brand-teal outline-none transition-all text-h4"
              />
            </div>
          </div>
          ...
          <div className="w-full lg:w-[380px] space-y-4">
            <label className="text-label text-brand-sage ml-2">Select Your State:</label>
            ...
            <div className="relative group">
              ...
              <select 
                ...
                className="w-full pl-14 pr-12 py-5 bg-white border border-gray-100 rounded-[24px] appearance-none font-bold text-h4 text-[#1F2937] shadow-sm hover:border-brand-teal focus:border-brand-teal outline-none transition-all cursor-pointer"
              >
            ...
            <Link to="/contact" className="block">
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-5 bg-[#76B56B] text-white rounded-[24px] font-kids font-bold text-h4 flex items-center justify-center gap-3 shadow-lg shadow-[#76B56B]/20 hover:bg-[#659e5a] transition-all"
              >
      ...
      <section className="px-6 lg:px-12 max-w-7xl mx-auto pb-32">
            ...
            {filteredProviders.map((provider) => (
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="text-h4 font-bold text-[#1F2937] leading-tight mb-2">
                    {provider.name}
                  </h3>
                  <div className="inline-flex px-3 py-1 bg-brand-mint/30 rounded-full text-label text-brand-teal">
                    In-Network
                  </div>
                </div>
              </motion.div>
        ...
        {filteredProviders.length === 0 && (
          ...
          >
            <p className="text-brand-sage font-medium text-body-lg italic">
