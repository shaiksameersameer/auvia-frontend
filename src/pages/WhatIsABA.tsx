...
export const WhatIsABA = () => {
  ...
  return (
    <div className="bg-[#F8FBFA] selection:bg-brand-teal/20 text-[#1F2937] font-sans overflow-x-hidden">
      ...
      <section className="relative pt-32 lg:pt-44 pb-20 lg:pb-32 px-6 lg:px-12 bg-gradient-to-b from-[#E0F7FA] via-white to-[#F8FBFA]">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-24 items-center relative z-10 text-center lg:text-left">
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-5 py-2 bg-[#E1F5FE] text-[#0288D1] rounded-full text-label mb-6 lg:mb-8 border border-[#0288D1]/10">
               <Microscope size={16} /> Science-Based Intervention
            </motion.div>
            
            <motion.h1 variants={fadeInUp} className="text-h1 font-kids font-bold text-brand-ink mb-8 lg:mb-10 leading-[0.9] tracking-tight">
              What is <br /><span className="text-brand-teal italic">ABA Therapy?</span>
            </motion.h1>
            
            <motion.div variants={fadeInUp} className="space-y-6 text-body-lg text-brand-sage font-medium max-w-xl mb-10 lg:mb-12 mx-auto lg:mx-0">
              <p>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row flex-wrap gap-4 lg:gap-5 justify-center lg:justify-start">
              <Link to="/contact" className="w-full sm:w-auto bg-brand-teal text-white px-8 lg:px-10 py-4 lg:py-5 rounded-[18px] lg:rounded-[22px] font-kids font-bold text-h4 hover:bg-[#3d7a6f] transition-all shadow-2xl flex items-center justify-center gap-3 group">
          ...
          >
            ...
            >
               <p className="font-kids font-bold text-h2 text-brand-teal italic leading-tight text-center">
      ...
      <section className="py-20 lg:py-32 px-6 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 lg:mb-24">
            <h2 className="text-h1 font-kids font-bold text-brand-ink mb-6 lg:mb-8">How ABA <span className="text-brand-teal italic">Works.</span></h2>
            <p className="text-body-lg text-brand-sage max-w-3xl mx-auto font-medium">ABA looks at how the environment affects a person's behavior using the "ABC" model:</p>
          </div>
            ...
            {[
              ...
              <motion.div key={i} whileHover={{ y: -15 }} className="bg-[#FCFAF7] p-8 lg:p-16 rounded-[40px] lg:rounded-[60px] border border-gray-50 text-center shadow-sm">
                <div className={`w-20 lg:w-28 h-20 lg:h-28 ${item.color} rounded-full flex items-center justify-center mx-auto mb-8 lg:mb-10 border-4 border-white shadow-lg`}>
                   <span className="text-h1 font-kids font-bold text-brand-teal">{item.letter}</span>
                </div>
                <h3 className="text-h3 font-kids font-bold mb-4 lg:mb-6">{item.title}</h3>
                <p className="text-body text-brand-sage font-medium">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 bg-[#FCFAF7] rounded-[100px] mx-6 shadow-sm border border-brand-teal/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <h2 className="text-h2 font-kids font-bold text-brand-ink mb-8">7 Dimensions <br /><span className="text-brand-teal italic">of ABA.</span></h2>
            <p className="text-body-lg text-brand-sage max-w-4xl mx-auto font-medium">
          ...
          <div className="bg-white p-12 lg:p-20 rounded-[80px] shadow-xl border border-brand-teal/5 mb-16 flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/3">
              <div className="w-24 h-24 bg-brand-mint/20 rounded-3xl flex items-center justify-center text-brand-teal mb-8">
                <Share2 size={48} />
              </div>
              <h3 className="text-h1 font-kids font-bold mb-6">Generalization</h3>
              <div className="inline-block px-4 py-1 bg-brand-teal text-white rounded-lg text-label">Dimension 01</div>
            </div>
            <div className="lg:w-2/3 space-y-6 text-brand-sage font-medium text-body-lg">
              ...
              <p className="p-8 bg-brand-mint/10 rounded-3xl border-l-8 border-brand-teal text-brand-ink text-h4 italic">"Understanding generalization helps children with autism become more successful in their daily lives."</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div key={i} whileHover={{ scale: 1.02 }} className="p-10 bg-white rounded-[50px] border border-brand-teal/5 shadow-sm flex flex-col gap-6">
                ...
                <h4 className="text-h3 font-kids font-bold text-brand-ink">{dim.title}</h4>
                <p className="text-body text-brand-sage font-medium">{dim.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-20 items-center mb-24">
            <motion.div 
              ...
              className="lg:w-1/2"
            >
              <h2 className="text-h2 font-kids font-bold text-brand-ink mb-10 leading-tight">
              ...
              <div className="p-8 bg-brand-mint/10 rounded-[40px] border-l-8 border-brand-teal">
                <p className="text-h4 font-bold text-brand-ink">
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="text-h3 font-kids font-bold text-brand-ink mb-6">{skill.title}</h3>
                <ul className="space-y-3">
                  {skill.items.map((item, idx) => (
                    <li key={idx} className="flex items-center gap-3 text-brand-sage font-medium text-body">
      ...
      <section className="py-32 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <motion.h2 
              initial="hidden" whileInView="visible" variants={fadeInUp} viewport={{ once: true }}
              className="text-h2 font-kids font-bold text-brand-ink mb-8 leading-tight"
            >
              Foundations for <br /><span className="text-brand-teal italic">Independence.</span>
            </motion.h2>
            <p className="text-body-lg text-brand-sage max-w-3xl mx-auto font-medium">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-10 -right-10 bg-brand-lavender p-10 rounded-[50px] text-white shadow-2xl max-w-xs rotate-3 border-8 border-white">
                 <p className="font-kids font-bold text-h4 italic">"Practice at home helps build a foundation for life."</p>
              </div>
            </motion.div>
            ...
            <div className="space-y-12">
              <div className="space-y-6 text-center lg:text-left">
                <h3 className="text-h2 font-kids font-bold text-brand-ink">Everyday Milestones.</h3>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {[
                  ...
                  >
                    ...
                    <span className="font-bold text-h4 text-brand-ink">{skill.title}</span>
                  </motion.div>
                ))}
              </div>

              <motion.div initial="hidden" whileInView="visible" variants={fadeInUp} viewport={{ once: true }} className="text-center lg:text-left">
                <Link to="/services" className="inline-flex items-center gap-3 text-brand-teal font-kids font-bold text-h3 group">
                  See How We Can Help 
      ...
      <section className="py-20 lg:py-32 bg-[#FCFAF7] rounded-[60px] lg:rounded-[100px] mx-4 lg:mx-6 shadow-sm border border-brand-teal/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 lg:mb-24">
            <motion.div 
              initial="hidden" whileInView="visible" variants={fadeInUp} viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-5 py-2 bg-brand-peach/20 text-brand-peach rounded-full text-label mb-6 mx-auto"
            >
               <Sunrise size={16} /> Bridging the Gap
            </motion.div>
            <h2 className="text-h2 font-kids font-bold text-brand-ink mb-6 lg:mb-8 leading-tight">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              {[
                ...
                <motion.div 
                  ...
                  className="bg-white p-8 rounded-[40px] shadow-sm border border-brand-teal/5 flex gap-6 items-start hover:shadow-md transition-all"
                >
                  ...
                  <div>
                    <h3 className="text-h3 font-bold text-brand-ink mb-2">{item.title}</h3>
                    <p className="text-body text-brand-sage font-medium">{item.desc}</p>
                  </div>
                </motion.div>
              ))}
            ...
            <motion.div 
              ...
              className="bg-brand-ink p-12 lg:p-16 rounded-[60px] text-white relative overflow-hidden shadow-2xl"
            >
              <Sunrise className="absolute top-0 right-0 opacity-10 -mr-16 -mt-16" size={300} />
              <div className="relative z-10">
                <h3 className="text-h2 font-kids font-bold mb-8">Early Learning, Early Success.</h3>
                <div className="space-y-6 text-body-lg text-white/70 font-medium mb-10">
                  <p>
                ...
                <Link to="/locations" className="inline-flex items-center gap-3 bg-brand-mint text-brand-ink px-10 py-5 rounded-2xl font-bold text-h4 hover:bg-white transition-all group shadow-lg">
      ...
      <section className="py-40 max-w-5xl mx-auto px-6">
        <h2 className="text-h1 font-kids font-bold text-brand-ink mb-20 text-center">Your Questions.</h2>
        <div className="space-y-6">
          {[
            ...
            <div key={index} className="bg-white rounded-[45px] border border-brand-teal/5 overflow-hidden shadow-sm hover:shadow-md transition-all">
              <button onClick={() => setOpenFAQ(openFAQ === index ? null : index)} className="w-full flex items-center justify-between p-10 text-left font-bold text-h4 font-kids group">
                {faq.q}
              ...
              <AnimatePresence>
                {openFAQ === index && (
                  <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }}>
                    <div className="px-10 pb-10 text-body text-brand-sage border-t border-brand-teal/5 pt-8 whitespace-pre-line">{faq.a}</div>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
      ...
      <section className="py-16 lg:py-24 px-6 lg:px-12 max-w-7xl mx-auto text-center">
        <div className="bg-brand-teal rounded-[40px] lg:rounded-[80px] p-10 lg:p-32 text-white relative overflow-hidden shadow-3xl">
          ...
          <h2 className="text-h1 font-kids font-bold mb-6 lg:mb-10 relative z-10">Join the Family.</h2>
          <p className="text-body-lg opacity-90 mb-10 lg:mb-16 max-w-3xl mx-auto relative z-10 font-medium">
            Join thousands of families who have experienced the Auvia difference in science-backed care.
          </p>
          <Link to="/contact" className="inline-block bg-white text-brand-teal px-10 lg:px-16 py-5 lg:py-7 rounded-[18px] lg:rounded-[24px] font-kids font-bold text-h3 hover:bg-brand-mint transition-all shadow-xl relative z-10">
            Book a Consultation
          </Link>
        </div>
      </section>
