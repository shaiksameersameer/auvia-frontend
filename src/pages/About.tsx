    ...
    <div className="pt-48 pb-32 bg-brand-cream overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative">
        ...
        <div className="max-w-4xl mb-32 relative z-10">
          <span className="text-brand-teal text-label mb-6 block font-kids">Our Story</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-40 relative z-10">
          {[
            ...
            <div key={i} className="card-friendly">
              ...
              <h3 className="text-h3 font-kids font-bold text-brand-ink mb-6">{value.title}</h3>
              <p className="text-brand-sage font-medium text-body">{value.text}</p>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center mb-32 relative z-10">
          <div className="lg:w-1/2">
            <h2 className="text-h2 font-kids font-bold text-brand-ink mb-10">A Happy Place for <br /><span className="italic text-brand-teal">Every Friend.</span></h2>
            <p className="text-brand-sage mb-8 font-medium text-body-lg">
            ...
            <p className="text-brand-sage mb-12 font-medium text-body-lg">
