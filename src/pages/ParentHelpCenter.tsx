      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-20 text-center md:text-left">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-teal/10 text-brand-teal text-label mb-6 mx-auto md:mx-0"
          >
            <BookOpen size={14} />
          ...
          <motion.h1 
            ...
            className="text-h1 font-kids font-bold text-brand-ink mb-8"
          >
          ...
          <motion.p
            ...
            className="text-body-lg text-brand-sage font-medium"
          >
          ...
          {resources.map((item, index) => (
            ...
            >
              <Link to={item.link} className={`group block h-full p-8 rounded-[40px] ${item.bgColor} border border-transparent hover:border-brand-teal/20 transition-all hover:shadow-xl`}>
                ...
                <h3 className="text-h3 font-kids font-bold text-brand-ink mb-4 group-hover:text-brand-teal transition-colors">
                  {item.title}
                </h3>
                <p className="text-brand-sage font-medium text-body mb-6">
                  {item.description}
                </p>
                <div className="flex items-center gap-2 text-brand-teal font-bold text-body-sm">
        ...
        <section className="mb-32">
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-brand-mint/10 rounded-[50px] p-10 md:p-14 border border-brand-mint/20">
              <h2 className="text-h2 font-kids font-bold text-brand-ink mb-6">What is Autism Like?</h2>
              <p className="text-brand-sage text-body-lg mb-8">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3 font-bold text-brand-teal text-body-lg">
              ...
              <Link to="/what-is-autism" className="text-brand-teal font-bold flex items-center gap-2 hover:underline text-body">
            ...
            <div className="bg-brand-peach/10 rounded-[50px] p-10 md:p-14 border border-brand-peach/20">
              <h2 className="text-h2 font-kids font-bold text-brand-ink mb-6">What is ABA Therapy Like?</h2>
              <p className="text-brand-sage text-body-lg mb-8">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3 font-bold text-brand-peach text-body-lg">
              ...
              <Link to="/what-is-aba" className="text-brand-peach font-bold flex items-center gap-2 hover:underline text-body">
        ...
        <section className="bg-brand-ink rounded-[60px] p-8 md:p-16 text-white mb-32 overflow-hidden relative">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-brand-peach text-label mb-6">
                <FileText size={14} />
                New Family Guide
              </div>
              <h2 className="text-h1 font-kids font-bold mb-8">What to expect in your <span className="text-brand-teal italic">first 90 days.</span></h2>
              <p className="text-white/70 text-body-lg mb-10 leading-relaxed max-w-xl">
              ...
              <Link to="/contact" className="inline-flex items-center gap-4 bg-brand-teal text-white px-10 py-5 rounded-2xl font-kids font-bold text-h4 hover:bg-[#3d7a6f] transition-all shadow-lg active:scale-95">
              ...
              <div className="bg-white/5 backdrop-blur-xl rounded-[40px] p-8 border border-white/10 shadow-2xl">
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="font-bold text-h4">Family Success Roadmap</p>
                      <p className="text-white/60 text-body-sm">Week 1: Initial Assessment & Observation</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="font-bold text-h4">Personalized Matching</p>
                      <p className="text-white/60 text-body-sm">Week 2: BCBA & RBT Introduction</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-h1 font-kids font-bold text-brand-ink mb-4">Common Questions</h2>
            <p className="text-body-lg text-brand-sage font-medium">Quick answers to help you navigate your options.</p>
          </div>
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-white p-8 rounded-3xl border border-brand-teal/5 shadow-sm hover:shadow-md transition-shadow"
              >
                <h4 className="text-h4 font-kids font-bold text-brand-ink mb-3">{faq.q}</h4>
                <p className="text-brand-sage font-medium text-body">{faq.a}</p>
              </motion.div>
            ))}
          </div>
        </section>
