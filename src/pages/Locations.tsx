        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-brand-teal text-label font-bold">
                Sanctuary Network
              </span>
            </div>
            <h1 className="text-h1 font-kids font-bold text-brand-ink mb-6 tracking-tight">
              Explore Our <br />
          ...
          <div className="p-8 sticky top-0 bg-white/95 backdrop-blur-sm z-20 border-b border-gray-100">
            <div className="space-y-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-brand-teal text-label ml-1">Search Area</label>
                <div className="bg-[#f8fbfa] border border-brand-teal/10 rounded-2xl flex items-center px-5 py-4 gap-3 focus-within:ring-2 ring-brand-teal/20 transition-all">
                  ...
                  <input
                    ...
                    className="bg-transparent w-full text-brand-ink text-h4 outline-none"
                    placeholder="City, State, or Zip Code..."
                  />
                  {query && (
                    <button onClick={() => setQuery('')} className="text-brand-sage hover:text-brand-teal transition-colors text-label">
                      Clear
                    </button>
                  )}
                </div>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-brand-teal text-label ml-1">Program Type</label>
                <div className="bg-[#f8fbfa] border border-brand-teal/10 rounded-2xl flex items-center px-5 py-4 gap-3">
                  ...
                  <select
                    ...
                    className="bg-transparent w-full text-brand-ink text-h4 outline-none appearance-none cursor-pointer"
                  >
              ...
              <p className="text-label text-brand-sage ml-1">{filtered.length} center{filtered.length !== 1 ? 's' : ''} found</p>
            </div>
          </div>
                  ...
                  {filtered.map((center) => (
                    ...
                    >
                      <div className="flex gap-5 mb-4">
                        ...
                        <div>
                          <h3 className="text-h4 font-bold text-brand-ink group-hover:text-brand-teal transition-colors">{center.name}</h3>
                          <div className="flex items-center gap-1.5 mt-1 text-brand-teal text-label">
                            <Sparkles size={12} /> Clinical Excellence
                          </div>
                        </div>
                      </div>

                      <div className="space-y-2.5 mb-6 text-body-sm text-gray-600">
        ...
        <div className={`flex-grow h-[500px] lg:h-auto relative ${viewMode === 'list' ? 'hidden lg:block' : 'block'}`}>
          ...
          <div className="absolute top-6 right-6 z-[400] hidden md:block">
            <div className="bg-white/90 backdrop-blur px-5 py-3 rounded-2xl shadow-xl border border-gray-100 flex items-center gap-3">
              ...
              <span className="text-label text-brand-ink">Live System Active</span>
            </div>
          </div>
        </div>
      </section>
