  ...
  return (
    <div className="pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-mint/30 text-brand-teal text-label">
            <Shield size={14} />
            Your Privacy Matters
          </div>
          <h1 className="text-h1 font-kids font-bold text-brand-ink mb-6">Privacy Policy</h1>
          <p className="text-brand-sage text-body-lg font-medium max-w-2xl mx-auto italic">
        ...
        >
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-brand-teal mb-2">
              <FileText size={24} />
              <h2 className="text-h3 font-kids font-bold tracking-tight">Introduction</h2>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-brand-teal mb-2">
              <Eye size={24} />
              <h2 className="text-h3 font-kids font-bold tracking-tight">Information Collection</h2>
            </div>
            <p className="text-brand-sage font-medium text-body">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-brand-teal mb-2">
              <Lock size={24} />
              <h2 className="text-h3 font-kids font-bold tracking-tight">How We Use Your Information</h2>
            </div>
            <p className="text-brand-sage font-medium text-body">
            ...
            <ul className="space-y-3 pl-4">
              {[
                ...
                <li key={i} className="flex items-start gap-4 text-brand-sage font-medium text-body">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-brand-teal mb-2">
              ...
              <h2 className="text-h3 font-kids font-bold tracking-tight">SMS Disclosure</h2>
            </div>
            <p className="text-brand-sage font-medium text-body">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-brand-teal mb-2">
              <Bell size={24} />
              <h2 className="text-h3 font-kids font-bold tracking-tight">Disclosure of Your Information</h2>
            </div>
            <p className="text-brand-sage font-medium text-body">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-brand-teal mb-2">
              <Globe size={24} />
              <h2 className="text-h3 font-kids font-bold tracking-tight">International Data Transfers</h2>
            </div>
            <p className="text-brand-sage font-medium text-body">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-brand-teal mb-2">
              <Clock size={24} />
              <h2 className="text-h3 font-kids font-bold tracking-tight">Data Retention</h2>
            </div>
            <p className="text-brand-sage font-medium text-body">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-brand-teal mb-2">
              <Cookie size={24} />
              <h2 className="text-h3 font-kids font-bold tracking-tight">Cookies and Tracking Technologies</h2>
            </div>
            <p className="text-brand-sage font-medium text-body">
          ...
          <section className="space-y-4 p-8 bg-brand-mint/10 rounded-[30px] border border-brand-teal/5">
            <div className="flex items-center gap-3 text-brand-teal mb-2">
              <Users size={24} />
              <h2 className="text-h3 font-kids font-bold tracking-tight">Your Choices</h2>
            </div>
          ...
          {/* 10. Policy Changes */}
          <section className="space-y-4">
            <h2 className="text-h3 font-kids font-bold text-brand-ink tracking-tight">Policy Changes</h2>
            <p className="text-brand-sage font-medium text-body">
