    ...
    <div className="bg-[#fdfcf0] min-h-screen relative">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full">
        ...
        >
          ...
          <h1 className="text-h1 font-kids font-bold text-brand-ink mb-8 lg:mb-12 tracking-tighter text-center lg:text-left">
            A New Standard <br className="hidden lg:block" />
            <span className="text-brand-teal italic">in Autism Care.</span>
          </h1>
          
          <p className="text-body-lg text-brand-sage font-medium max-w-2xl mx-auto lg:mx-0 pl-6 border-l-2 border-brand-teal/20 text-center lg:text-left mb-6">
          ...
          <div className="bg-brand-teal/5 p-4 rounded-2xl border border-brand-teal/10 text-brand-teal font-bold text-body-sm max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
            ...
            {services.map((service, idx) => (
              ...
              >
                <div className="w-full lg:w-1/2 text-center lg:text-left">
                  <div className={`inline-flex items-center gap-3 px-6 lg:px-8 py-2.5 lg:py-3 rounded-full ${service.color} text-brand-teal text-label font-kids mb-8 lg:mb-10 border border-brand-teal/10`}>
                    {service.icon}
                    {service.age}
                  </div>
                  <h2 className="text-h1 font-kids font-bold text-brand-ink mb-8 lg:mb-10">
                    {service.title}
                  </h2>
                  <p className="text-body-lg text-brand-sage mb-10 lg:mb-12 font-medium">
                    {service.description}
                  </p>
                  
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 lg:gap-y-8 gap-x-8 lg:gap-x-12 mb-12 lg:mb-16 text-left">
                    {service.features.map(f => (
                      <div key={f} className="flex items-center gap-4 lg:gap-5 text-body font-bold text-brand-ink font-kids group">
                  ...
                  <div className="flex flex-col sm:flex-row flex-wrap gap-6 lg:gap-8 items-center justify-center lg:justify-start">
                    <button 
                      ...
                      className="w-full sm:w-auto bg-brand-ink text-white px-10 lg:px-12 py-5 lg:py-6 rounded-[24px] lg:rounded-[30px] font-kids font-bold text-h4 hover:bg-brand-teal transition-all duration-500 flex items-center justify-center gap-4 shadow-2xl active:scale-95"
                    >
                      Enroll Now <ArrowRight size={22} />
                    </button>
                    <div className="flex items-center gap-3 text-brand-sage text-label">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center lg:items-end mb-16 lg:mb-24 text-center lg:text-left">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-brand-teal text-label font-kids mb-4 lg:mb-6 block">
              The Auvia Standard
            </span>
            <h2 className="text-h2 font-kids font-bold text-brand-ink">
          ...
          <motion.p 
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="text-body-lg text-brand-sage font-medium max-w-lg mx-auto lg:mx-0"
          >
            ...
            >
              ...
              <div className="space-y-3 lg:space-y-4 mb-10 lg:mb-12 flex-grow text-left">
                {pillar.details.map((detail, dIdx) => (
                  <div key={dIdx} className="flex items-center gap-3 text-body-sm font-bold text-brand-ink/80 font-kids">
      ...
      <section className="py-24 lg:py-40 px-6 lg:px-12 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h3 className="text-h2 font-kids font-bold text-brand-ink italic">
          ...
          <div className="mt-12 lg:mt-16 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-brand-sage text-label">BCBA-D SPECIALIST</p>
            </div>
          </div>
        </div>
      </section>
