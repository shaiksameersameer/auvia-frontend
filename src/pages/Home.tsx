...
const FAQItem = ({ faq, variants }: { key?: number; faq: { q: string; a: string }; variants: any }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className={`text-small-heading font-bold transition-colors duration-300 ${isOpen ? "text-brand-teal" : "text-brand-ink"
          }`}>
          {faq.q}
        </h3>
        <motion.div
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="px-8 pb-8 text-brand-sage text-body-normal-normal leading-relaxed max-w-3xl">
